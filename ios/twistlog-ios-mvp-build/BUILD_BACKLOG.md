...
- Notification copy says `Reminder: check your bottle.`
...
Start with an in-memory observable store. It makes the flow easy to review. After flow approval, replace persistence with SwiftData.

## First Product Shortcut

Keep one reminder time per bottle in the first TestFlight. Multiple reminder times can come after the core opening flow is validated.
